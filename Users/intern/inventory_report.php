            ...
            <form method="POST" action="">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm" id="reportTable">
                        <thead>
                            <tr>
                                <th style="min-width: 80px;">Reorder Status</th>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculateTotals() {
                ...
                rows.forEach(row => {
                    ...
                    reorderSelect.value = reorderSelect.value;
                    reorderPointInput.value = reorderPointInput.value;
                    reorderQtyInput.value = reorderQtyInput.value;
                });
            }
            ...
            // Listen for input changes to calculate Value and check reorder logic
